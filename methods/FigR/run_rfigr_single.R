...
#     # try system.path 
#     dir.create(system.file(out_dir,"rfigr", package="RcppBDT"),recursive=TRUE)
#     print("------ Saving integration and cell pairing result ------")
#     write.csv(c(1,2,3,4),system.file(out_dir,"rfigr","rfigr_result.csv", package="RcppBDT"))
    ...
    #dir.create(file.path(paste0(out_dir,"rfigr/"),recursive=TRUE)
    print("------ Saving integration and cell pairing result ------")
